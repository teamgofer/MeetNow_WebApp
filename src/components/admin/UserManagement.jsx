                    ...
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                        {user.avatar_url ? (
                          ...
                          <span className="text-gray-500 font-bold">{user.username?.[0] || user.display_name?.[0] || '?'}</span>
                        )}
                      </div>
                      <div className="ml-4">
                        <div className="text-sm font-medium text-gray-900">{user.display_name || 'No display name'}</div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="isAdmin" className="text-sm font-medium text-gray-700">Admin User</label>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600">
                Adding credits to user: {users.find(u => u.id === selectedUserId)?.username || selectedUserId}
              </p>
            </div>
            <div className="mt-6 flex justify-end space-x-3">
              <button
