...
export type TWithLoading = <P extends object>(
  WrappedComponent: ComponentType<P>,
  options?: WithLoadingOptions
) => ComponentType<P & LoadingStateProps>;

export type TWithMobileResponsive = <P extends object>(
  WrappedComponent: ComponentType<P>,
  options?: WithMobileResponsiveOptions
) => ComponentType<P & MobileResponsiveProps>;

export type TWithOfflineSupport = <P extends object>(
  WrappedComponent: ComponentType<P>,
  options?: WithOfflineSupportOptions
) => ComponentType<P & OfflineSupportProps>;

export type TWithErrorHandling = <P extends object>(
  WrappedComponent: ComponentType<P>,
  options?: WithErrorHandlingOptions
) => ComponentType<P>;

export type TWithPerformanceTracking = <P extends object>(
  WrappedComponent: ComponentType<P>,
  options?: WithPerformanceTrackingOptions
) => ComponentType<P>;

export type TWithExtractionMonitor = <P extends object>(
  WrappedComponent: ComponentType<P>,
  options?: WithExtractionMonitorOptions
) => ComponentType<P>;
