...
const LocationPermissionModal = ({ isOpen, onClose, permissionStatus, onRequestPermission }) => {
      ...
      case 'denied':
        return (
          <div className="text-center p-4">
            ...
            <p className="mb-4">
              Please enable location access in your browser settings to get the most out of MeetNow.
            </p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-4 text-left">
              ...
              <ul className="list-disc pl-5 text-sm space-y-1">
                ...
                <li>
                  <strong>Firefox:</strong> Options → Privacy & Security → Permissions → Location
                </li>
                <li>
                  <strong>Safari:</strong> Preferences → Privacy → Location Services
                </li>
                <li>
                  <strong>Edge:</strong> Settings → Site Permissions → Location
                </li>
              </ul>
            </div>
      ...
      default:
        return (
          <div className="text-center p-4">
            ...
            <p className="mb-6">
              MeetNow needs your location to show you nearby meetups and help others find you.
            </p>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full">{getStatusContent()}</div>
    </div>
  );
};
