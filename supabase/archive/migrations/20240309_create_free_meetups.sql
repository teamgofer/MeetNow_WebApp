...
BEGIN
  ...
  IF EXISTS (
    ...
    RAISE NOTICE 'pg_cron job scheduled successfully for free meetups';
  ELSE
    RAISE NOTICE 'pg_cron extension not available. Manual cleanup will be required for free meetups';
  END IF;
END $do$; 