...
vi.mock(
  '../../components/MessageHistoryHeader',
  () =>
    ({ regionName, messageCount, enteredAreaTime }) => (
...
vi.mock('../../components/MessageList', () => ({ messages, isHistory, hasMore, onLoadMore }) => (
...
describe('ChatMessageHistory', () => {
  ...
  it('should render with history messages', () => {
    render(<ChatMessageHistory regionName="Test Region" regionTimeInfo={mockTimeInfo} />);
  ...
  it('should call markAsRead on unmount', () => {
    const { unmount } = render(
      <ChatMessageHistory regionName="Test Region" regionTimeInfo={mockTimeInfo} />
    );
  ...
  it('should not render when regionTimeInfo is missing', () => {
    const { container } = render(<ChatMessageHistory regionName="Test Region" />);
  ...
  it('should reuse region name from time info if not provided directly', () => {
    ...
    render(<ChatMessageHistory regionTimeInfo={timeInfoWithRegionName} />);
  ...
  it('should handle regionTimeInfo changes', () => {
    ...
    rerender(<ChatMessageHistory regionName="Test Region" regionTimeInfo={newTimeInfo} />);
