...
const ChatRegionEntryNotice = ({
  ...
  return (
    <div className={`chat-region-entry-notice ${className}`} style={style}>
      <div className="notice-content">
        ...
        <div className="notice-text">
          <div className="notice-title">You've entered {regionName || `the ${regionId} area`}</div>

          {messageCount > 0 && (
            <div className="notice-message-count">
              There {messageCount === 1 ? 'is' : 'are'} {messageCount}{' '}
              {messageCount === 1 ? 'message' : 'messages'} from before you arrived
            </div>
          )}
        </div>
        ...
        <div className="notice-actions">
          ...
          <button className="close-notice-button" onClick={handleClose}>
...
ChatRegionEntryNotice.propTypes = {
  ...
  enteredAt: PropTypes.oneOfType([PropTypes.string, PropTypes.instanceOf(Date)]).isRequired,
