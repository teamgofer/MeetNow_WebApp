...
const AnimatedUserLocationMarker = ({ position, accuracy = 0, showPopup = false }) => {
    const size = [64, 64];
    const anchor = [32, 32];
    ...
    return (_jsx(Marker, { position: position, icon: icon, zIndexOffset: 1000, children: showPopup && (_jsx(Popup, { children: _jsxs("div", { children: [_jsx("strong", { children: "Your Location" }), accuracy > 0 && (_jsxs("p", { children: ["Accuracy: \u00B1", Math.round(accuracy), " meters"] }))] }) })) }));
};
export default AnimatedUserLocationMarker;
//# sourceMappingURL=AnimatedUserLocationMarker.js.map