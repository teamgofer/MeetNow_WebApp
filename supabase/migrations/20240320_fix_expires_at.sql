-- Fix for expires_at column removal
-- Drop and recreate the search function to use the view instead

-- Drop the existing function
DROP FUNCTION IF EXISTS search_nearby_free_meetups(double precision, double precision, integer, integer);

-- Recreate the function using the meetups_with_expiry view
