    ...
    <div className="neu-demo-container">
      ...
      <DemoSection title="Cards">
        <div className="neu-demo-grid">
          <NeuCard header="Default Card" footer="Card Footer" className="neu-demo-card">
            This is the content of a default card.
          </NeuCard>

          <NeuCard variant="primary" header="Primary Card" className="neu-demo-card">
            Card with primary styling.
          </NeuCard>

          <NeuCard variant="luxury" header="Luxury Card" className="neu-demo-card">
            Card with luxury styling.
          </NeuCard>

          <NeuCard variant="playful" header="Playful Card" className="neu-demo-card">
      ...
      <DemoSection title="Input Fields">
        <div className="neu-demo-column">
          ...
          <NeuInput label="Input with icon" placeholder="Search..." icon={<ActionIcons.Search />} />
          ...
          <NeuInput label="Disabled input" value="Can't edit this" disabled={true} />
        </div>
      </DemoSection>
      ...
      <DemoSection title="Alerts">
        <div className="neu-demo-column">
          <NeuAlert title="Info Alert">This is an informative message.</NeuAlert>

          <NeuAlert title="Success Alert" variant="success">
            Operation completed successfully!
          </NeuAlert>

          <NeuAlert title="Warning Alert" variant="warning">
            This action might cause issues.
          </NeuAlert>

          <NeuAlert title="Error Alert" variant="error" onClose={() => console.log('Alert closed')}>
      ...
      <DemoSection title="Progress Bars">
        <div className="neu-demo-column">
          <NeuProgress value={30} label="Default Progress" />

          <NeuProgress value={50} label="Primary Progress" variant="primary" />

          <NeuProgress value={70} label="Success Progress" variant="success" />

          <NeuProgress value={90} label="Danger Progress" variant="danger" />
        </div>
      </DemoSection>
      ...
      <DemoSection title="Tabs">
        ...
        <div style={{ marginTop: '20px' }}>
          <NeuTabs tabs={tabs} variant="primary" alignment="center" />
        </div>
      </DemoSection>

      {/* Navigation */}
      <DemoSection title="Navigation">
        <NeuNavigation items={navItems} variant="default" />

        <div style={{ marginTop: '20px' }}>
          <NeuNavigation items={navItems} variant="neumorphic" position="bottom" />
        </div>
      </DemoSection>
      ...
      <DemoSection title="Avatars">
        <div className="neu-demo-row">
          <NeuAvatar initials="JD" size="small" />

          <NeuAvatar initials="JD" size="medium" />

          <NeuAvatar initials="JD" size="large" />

          <NeuAvatar src="https://via.placeholder.com/150" alt="Jane Doe" size="large" />

          <NeuAvatar icon={<ActionIcons.Profile />} size="large" variant="primary" />
        </div>

        <div className="neu-demo-row">
          <NeuAvatar initials="JD" status="online" />

          <NeuAvatar initials="JD" status="away" />

          <NeuAvatar initials="JD" status="busy" />

          <NeuAvatar initials="JD" status="offline" />
        </div>
      </DemoSection>

      {/* Modal */}
      <DemoSection title="Modal">
        <NeuButton onClick={() => setIsModalOpen(true)}>Open Modal</NeuButton>
        ...
        <NeuModal
          ...
          footer={
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
              <NeuButton variant="minimal" onClick={() => setIsModalOpen(false)}>
                Cancel
              </NeuButton>
              <NeuButton variant="primary" onClick={() => setIsModalOpen(false)}>
                Confirm
              </NeuButton>
            </div>
          }
        >
          ...
          <NeuInput label="Sample input in modal" placeholder="Type something..." />
        </NeuModal>
      </DemoSection>
    </div>
  );
