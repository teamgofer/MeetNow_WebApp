  ...
  return (
    ...
    >
      ...
      {!isCurrentUser && !isSystemMessage && (
        <div className={styles.avatar}>
          {message.user?.avatar ? (
            ...
            <div className={styles.avatarInitial}>{message.user?.name?.charAt(0) || '?'}</div>
          )}
        </div>
      )}
      ...
      <div className={styles.messageContent}>
        ...
        {!isCurrentUser && !isSystemMessage && (
          <div className={styles.userName}>{message.user?.name || 'Unknown User'}</div>
        )}
        ...
        <div className={styles.messageMetadata}>
          ...
          {isCurrentUser && message.isRead && <span className={styles.readStatus}>Read</span>}
