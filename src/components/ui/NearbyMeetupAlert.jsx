    ...
    <div className={`bg-white rounded-lg shadow-lg p-4 ${className}`}>
      <div className="flex items-start">
        ...
        <div className="ml-3 flex-1">
          <h3 className="text-sm font-medium text-gray-900">New Meetup Nearby</h3>
          <div className="mt-1 text-sm text-gray-500">
            <p className="font-medium">{meetup.title}</p>
            <p className="mt-1">{meetup.location?.display_name}</p>
            <p className="mt-1">{new Date(meetup.start_time).toLocaleString()}</p>
          </div>
...
const MultipleMeetupsAlert = ({
  ...
  return (
    <div className="nearby-meetup-alert" onClick={handleView} role="alert">
