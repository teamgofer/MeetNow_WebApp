 ...
 */
export const ModalHeader: React.FC<IModalSubcomponentProps> = ({ children, className = '' }) => (
 ...
 */
export const ModalBody: React.FC<IModalSubcomponentProps> = ({ children, className = '' }) => (
 ...
 */
export const ModalFooter: React.FC<IModalSubcomponentProps> = ({ children, className = '' }) => (
