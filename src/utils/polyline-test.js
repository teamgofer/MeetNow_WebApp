...
console.log('First few points:', JSON.stringify(standardDecoding.slice(0, 3)));
console.log('Last few points:', JSON.stringify(standardDecoding.slice(-3)));

console.log('\nFlipped standard points:', flippedStandard.length);
console.log('First few points:', JSON.stringify(flippedStandard.slice(0, 3)));
console.log('Last few points:', JSON.stringify(flippedStandard.slice(-3)));
