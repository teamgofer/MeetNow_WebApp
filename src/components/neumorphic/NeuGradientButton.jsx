...
const NeuGradientButton = ({
  ...
  return (
    <Component {...componentProps}>
      {showRipple && (
        <span 
          className="neu-gradient-button-ripple"
          style={rippleStyle}
        />
      )}
      
      {icon && iconPosition === 'left' && (
        <span className="neu-gradient-button-icon neu-gradient-button-icon-left">
          {icon}
        </span>
      )}
      ...
      {icon && iconPosition === 'right' && (
        <span className="neu-gradient-button-icon neu-gradient-button-icon-right">
          {icon}
        </span>
      )}
      
      {sheen && (
        <span className="neu-gradient-button-sheen-effect" />
      )}
    </Component>
  );
};
...
NeuGradientButton.propTypes = {
  ...
  variant: PropTypes.oneOf([
    ...
    'warning', 'info', 'ocean', 'sunset', 'rainbow'
  ]),
  /** Size variant */
