...
const ProximityChatTestPage = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribeConnectionStatus = proximityChatService.onConnectionStatus(handleConnectionStatus);
    ...
    <div className="max-w-4xl mx-auto p-4 h-screen flex flex-col">
      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-4">
        ...
        <div className="grid grid-cols-3 gap-2 max-w-xs mx-auto mb-2">
          <button onClick={() => shiftLocation(0.001, 0)} className="p-2 bg-blue-200 rounded">North</button>
          <div></div>
          <button onClick={() => shiftLocation(-0.001, 0)} className="p-2 bg-blue-200 rounded">South</button>
          <button onClick={() => shiftLocation(0, -0.001)} className="p-2 bg-blue-200 rounded">West</button>
          <div></div>
          <button onClick={() => shiftLocation(0, 0.001)} className="p-2 bg-blue-200 rounded">East</button>
        </div>
