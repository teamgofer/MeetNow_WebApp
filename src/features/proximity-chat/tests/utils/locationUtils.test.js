...
describe('locationUtils', () => {
  describe('calculateDistance', () => {
    ...
    it('should handle short distances accurately', () => {
      ...
      const point2 = { latitude: 37.775, longitude: -122.4195 }; // Very close
  ...
  describe('isLocationWithinRadius', () => {
    ...
    it('should return true for locations within the radius', () => {
      const nearbyLocation = { latitude: 37.775, longitude: -122.4195 };
    ...
    it('should return false for invalid locations', () => {
      ...
      expect(isLocationWithinRadius({ lat: 37.7749, lng: -122.4194 }, centerLocation, 10)).toBe(
        false
      );
    });
