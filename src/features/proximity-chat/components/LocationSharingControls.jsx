    ...
    <div className="location-sharing-controls">
      ...
      <div className={`location-controls-content ${!locationSettings.isEnabled ? 'disabled' : ''}`}>
          ...
          <div className="auto-disable-controls">
            ...
            {locationSettings.autoDisableWhenInactive && (
              <div className="timeout-control">
                <label htmlFor="inactivity-timeout">Disable after inactivity for</label>
                <input
                  type="number"
        ...
        <div className="location-sharing-actions">
          <button
            ...
            disabled={!locationSettings.isEnabled}
            {...createAccessibleButtonProps(handleSettingsSave, 'Save location sharing settings')}
          >
            Save Settings
          </button>
        </div>
      ...
      <div className="location-sharing-info">
        ...
        <div className="info-content">
          <p>
            Your location is only used to match you with nearby users for chat. It is not stored
            permanently and is refreshed regularly when active.
          </p>
          <p>
            When location sharing is disabled, you won't be visible to others in the proximity chat,
            and you won't receive messages.
          </p>
        </div>
      </div>
    </div>
