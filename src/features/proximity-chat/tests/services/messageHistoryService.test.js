...
describe('messageHistoryService', () => {
  ...
  describe('loadMessageHistory', () => {
    ...
    it('should throw an error when API request fails', async () => {
      ...
      await expect(messageHistoryService.loadMessageHistory('region-123')).rejects.toThrow(error);
    });
  });
  ...
  describe('loadOlderMessages', () => {
    ...
    it('should propagate errors from loadMessageHistory', async () => {
      ...
      await expect(
        messageHistoryService.loadOlderMessages('region-123', 1686571200000)
  ...
  describe('loadMessagesBeforeArrival', () => {
    ...
    it('should propagate errors from loadMessageHistory', async () => {
      ...
      await expect(
        messageHistoryService.loadMessagesBeforeArrival('region-123', 1686571200000)
      ).rejects.toThrow(error);
    });
  });
  ...
  describe('markMessagesAsRead', () => {
    ...
    it('should throw an error when API request fails', async () => {
      ...
      await expect(messageHistoryService.markMessagesAsRead('region-123')).rejects.toThrow(error);
    });
  });
  ...
  describe('deleteMessage', () => {
    ...
    it('should throw an error when API request fails', async () => {
      ...
      await expect(messageHistoryService.deleteMessage('msg-123')).rejects.toThrow(error);
    });
  });
});
