...
export const ComponentStateProvider = ({ children }) => {
  ...
  const meetupActions = {
    setActiveMeetup: useCallback(
      meetup => dispatch({ type: ActionTypes.SET_ACTIVE_MEETUP, payload: meetup }),
      []
    ),
    setNearbyMeetups: useCallback(
      meetups => dispatch({ type: ActionTypes.SET_NEARBY_MEETUPS, payload: meetups }),
      []
    ),
    setJoinedMeetups: useCallback(
      meetups => dispatch({ type: ActionTypes.SET_JOINED_MEETUPS, payload: meetups }),
      []
    ),
    setCreatedMeetups: useCallback(
      meetups => dispatch({ type: ActionTypes.SET_CREATED_MEETUPS, payload: meetups }),
      []
    ),
    setCreatingMeetup: useCallback(
      isCreating => dispatch({ type: ActionTypes.SET_CREATING_MEETUP, payload: isCreating }),
      []
    ),
    setJoiningMeetup: useCallback(
      isJoining => dispatch({ type: ActionTypes.SET_JOINING_MEETUP, payload: isJoining }),
      []
    ),
    updateFilters: useCallback(
      filters => dispatch({ type: ActionTypes.UPDATE_FILTERS, payload: filters }),
      []
    ),
  };
  ...
  const mapActions = {
    setMapCenter: useCallback(
      center => dispatch({ type: ActionTypes.SET_MAP_CENTER, payload: center }),
      []
    ),
    setMapZoom: useCallback(
      zoom => dispatch({ type: ActionTypes.SET_MAP_ZOOM, payload: zoom }),
      []
    ),
    setUserLocation: useCallback(
      location => dispatch({ type: ActionTypes.SET_USER_LOCATION, payload: location }),
      []
    ),
    setMapInitialized: useCallback(
      isInitialized => dispatch({ type: ActionTypes.SET_MAP_INITIALIZED, payload: isInitialized }),
      []
    ),
    setLocationLoading: useCallback(
      isLoading => dispatch({ type: ActionTypes.SET_LOCATION_LOADING, payload: isLoading }),
      []
    ),
    setVisibleMarkers: useCallback(
      markers => dispatch({ type: ActionTypes.SET_VISIBLE_MARKERS, payload: markers }),
      []
    ),
    setActiveMarkerId: useCallback(
      markerId => dispatch({ type: ActionTypes.SET_ACTIVE_MARKER_ID, payload: markerId }),
      []
    ),
  };
  ...
  const userActions = {
    setUserProfile: useCallback(
      profile => dispatch({ type: ActionTypes.SET_USER_PROFILE, payload: profile }),
      []
    ),
    ...
    setProfileLoading: useCallback(
      isLoading => dispatch({ type: ActionTypes.SET_PROFILE_LOADING, payload: isLoading }),
      []
    ),
    updatePreferences: useCallback(
      preferences => dispatch({ type: ActionTypes.UPDATE_PREFERENCES, payload: preferences }),
      []
    ),
    setNotifications: useCallback(
      notifications => dispatch({ type: ActionTypes.SET_NOTIFICATIONS, payload: notifications }),
      []
    ),
  };
  ...
  const uiActions = {
    setBottomSheetState: useCallback(
      state => dispatch({ type: ActionTypes.SET_BOTTOM_SHEET_STATE, payload: state }),
      []
    ),
    setActiveModal: useCallback(
      modal => dispatch({ type: ActionTypes.SET_ACTIVE_MODAL, payload: modal }),
      []
    ),
    setMenuOpen: useCallback(
      isOpen => dispatch({ type: ActionTypes.SET_MENU_OPEN, payload: isOpen }),
      []
    ),
    addToast: useCallback(
      toast => dispatch({ type: ActionTypes.ADD_TOAST, payload: { id: Date.now(), ...toast } }),
      []
    ),
    removeToast: useCallback(id => dispatch({ type: ActionTypes.REMOVE_TOAST, payload: id }), []),
    setCurrentTab: useCallback(
      tab => dispatch({ type: ActionTypes.SET_CURRENT_TAB, payload: tab }),
      []
    ),
    setLoading: useCallback(
      isLoading => dispatch({ type: ActionTypes.SET_LOADING, payload: isLoading }),
      []
    ),
    setError: useCallback(
      (key, error) => dispatch({ type: ActionTypes.SET_ERROR, payload: { key, error } }),
      []
    ),
    clearError: useCallback(key => dispatch({ type: ActionTypes.CLEAR_ERROR, payload: key }), []),
  };
