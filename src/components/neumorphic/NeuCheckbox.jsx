...
const NeuCheckbox = ({
  ...
  return (
    <label
      className={`neu-checkbox-container ${className} ${disabled ? 'neu-checkbox-disabled' : ''}`}
    >
      <div
        className={`neu-checkbox-wrapper ${getVariantClass()} ${getSizeClass()} ${error ? 'neu-checkbox-error' : ''}`}
      >
        <input
          type="checkbox"
          checked={checked}
