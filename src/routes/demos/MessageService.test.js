...
describe('MessageService', () => {
  ...
  describe('getMessages', () => {
    ...
    it('should handle errors', async () => {
      ...
      await expect(messageService.getMessages({ sessionId: 'test-session' })).rejects.toThrow(
  ...
  describe('deleteMessage', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(messageService.deleteMessage('msg1')).rejects.toThrow(
  ...
  describe('reportMessage', () => {
    ...
    it('should throw error if messageId is missing', async () => {
      await expect(messageService.reportMessage(null, 'test-session', 'spam')).rejects.toThrow(
    ...
    it('should handle API errors', async () => {
      ...
      await expect(messageService.reportMessage('msg123', 'test-session', 'spam')).rejects.toThrow(
