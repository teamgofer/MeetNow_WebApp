...
const DebugConsole = ({ isVisible = true, className = '', mapRef, mapNavigator, userLocation, selectedLocation, onNavigationTest, }) => {
    ...
    if (!isVisible)
        return null;
    return (_jsxs("div", { className: `fixed bottom-0 right-0 w-96 h-64 bg-gray-900 text-white p-4 ${className}`, children: [_jsxs("div", { className: "flex justify-between items-center mb-2", children: [_jsx("h3", { className: "text-sm font-semibold", children: "Debug Console" }), _jsxs("div", { className: "flex space-x-2", children: [_jsx("button", { onClick: clearLogs, className: "text-xs px-2 py-1 bg-gray-700 hover:bg-gray-600 rounded", children: "Clear" }), _jsx("button", { onClick: exportLogs, className: "text-xs px-2 py-1 bg-gray-700 hover:bg-gray-600 rounded", children: "Export" })] })] }), _jsx("div", { ref: consoleRef, className: "h-[calc(100%-2rem)] overflow-y-auto font-mono text-xs", children: logs.map((log, index) => (_jsx("div", { className: "whitespace-pre-wrap", children: log }, index))) }), _jsx("div", { className: "absolute bottom-4 right-4 flex space-x-2", children: _jsx("button", { onClick: runMapTest, className: "text-xs px-2 py-1 bg-blue-600 hover:bg-blue-500 rounded", children: "Test Navigation" }) })] }));
};
