...
describe('MeetNowApp', () => {
  ...
  it('handles geolocation error', () => {
    jest.spyOn(require('../../hooks/useGeolocation'), 'useGeolocation').mockReturnValue({
      location: null,
      isLoading: false,
  ...
  it('handles meetups error', () => {
    jest.spyOn(require('../../hooks/useMeetups'), 'useMeetups').mockReturnValue({
      meetups: null,
      isLoading: false,
      error: 'Meetups error',
    });
  ...
  it('logs location selection', () => {
    ...
    jest.spyOn(require('../../hooks/useLogger'), 'useLogger').mockReturnValue(mockLogger);
