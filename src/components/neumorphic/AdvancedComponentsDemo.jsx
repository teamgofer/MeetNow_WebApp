      ...
      <DemoSection title="Accordions">
        <div className="neu-demo-accordion">
          <NeuAccordion>
            ...
            >
              <p>
                Neumorphism is a design trend that combines elements of skeuomorphism and flat design.
                It features soft, extruded shapes, achieved through subtle shadow contrasts that give UI elements
                the appearance of being pushed out from the background.
              </p>
            </NeuAccordionItem>
            
            <NeuAccordionItem 
              title="How to use these components" 
              icon={<ActionIcons.Question />}
            >
              <p>
                These components can be easily integrated into your React projects.
                Simply import the desired component and include it in your JSX.
                Each component accepts various props for customization, such as variant, size, and specific features.
              </p>
...
<NeuAccordion>
  <NeuAccordionItem title="Accordion Title">
    Content goes here...
            ...
            >
              <p>
                All components can be customized with different:
              </p>
      ...
      <DemoSection title="Glassmorphism Cards">
        <div className="neu-demo-glassmorphism">
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <NeuGlassCard 
              header="Default Glass Card" 
              style={{ width: '250px' }}
            >
              Glassmorphism features transparency, blur effects, and subtle borders
      ...
      <DemoSection title="Animated Carousel">
        ...
        <div style={{ display: 'flex', gap: '15px', justifyContent: 'center', marginTop: '20px' }}>
          ...
          <NeuButton size="small" variant="primary">Fade Animation</NeuButton>
        ...
        <NeuCard 
          ...
          footer={
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
              <NeuButton variant="minimal" size="small">Cancel</NeuButton>
              <NeuGradientButton size="small" variant="primary" sheen>Save Changes</NeuGradientButton>
            </div>
          }
