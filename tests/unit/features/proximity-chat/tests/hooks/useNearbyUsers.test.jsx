...
describe('useNearbyUsers', () => {
  ...
  const mockNearbyUsers = [
    ...
    { id: 'user2', name: 'Jane', location: { latitude: 37.7750, longitude: -122.4195 } }
  ];
  ...
  it('should sort users by distance from current user', () => {
    ...
    jest.mock('../../utils/locationUtils', () => ({
      ...
      isLocationWithinRadius: jest.requireActual('../../utils/locationUtils').isLocationWithinRadius
    }));
  ...
  it('should re-compute users when user location changes', () => {
    ...
    const newLocation = { latitude: 40.7128, longitude: -74.0060 }; // New York
