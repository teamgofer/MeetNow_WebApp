    ...
    return (
      <div className="error-container p-4 bg-blue-50 rounded-lg">
        ...
        <ul className="list-disc pl-5 mb-4">
          <li><strong>Extended Meetups:</strong> Create meetups longer than 1 hour</li>
          <li><strong>Custom Participant Limits:</strong> Host larger gatherings</li>
          <li><strong>Priority Listing:</strong> Make your meetups more visible</li>
        </ul>
    ...
    <div className="credits-container p-4">
      ...
      <div className="credits-balance bg-blue-50 p-4 rounded-lg mb-6">
        ...
        <ul className="list-disc pl-5">
          <li><strong>Create Extended Meetups:</strong> While unregistered users are limited to 1-hour meetups, you can create meetups lasting up to 5 hours!</li>
          <li><strong>Access Premium Features:</strong> Enhance your meetup experience with exclusive options</li>
        </ul>
      </div>
      ...
      <div className="credits-purchase bg-gray-50 p-4 rounded-lg mb-6">
        ...
        <form onSubmit={purchaseCredits}>
          <div className="form-group mb-4">
            <label htmlFor="purchaseAmount" className="block mb-2 font-medium">Amount to Purchase</label>
            <select
              id="purchaseAmount"
      ...
      <div className="credits-usage bg-gray-50 p-4 rounded-lg">
        ...
        <div>
          ...
          <ul className="list-disc pl-5">
            <li><strong>Increase Participant Limit:</strong> 50 credits per 10 additional participants</li>
            <li><strong>Featured Meetups:</strong> 100 credits to highlight your meetup</li>
            <li><strong>Premium Themes:</strong> Customize your meetup appearance</li>
          </ul>
        </div>
      </div>
    </div>
