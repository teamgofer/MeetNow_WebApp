  ...
  return jest.fn(props => (
    <div data-testid="mocked-distance-slider">
      ...
      <input 
        ...
        onChange={(e) => props.onChange && props.onChange(parseInt(e.target.value, 10))}
...
const originalIsFeatureEnabled = jest.requireActual('../../../config/featureFlags').isFeatureEnabled;
...
describe('SearchFilter Component', () => {
  ...
  test('updates filters when extracted DistanceSlider changes', () => {
    ...
    const { updateFilters } = require('../../../contexts/ComponentStateContext').useMeetupState().meetupActions;
