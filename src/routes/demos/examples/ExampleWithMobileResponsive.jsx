    ...
    <div className="p-4">
      ...
      >
        ...
        >
          ...
          <p>
            This card adjusts its width and text size based on the device type.
            On mobile, it takes full width, on tablet 50%, and on desktop 33.33%.
          </p>
        </div>
        ...
        >
          ...
          <p>
            The layout and spacing also adjust automatically based on the screen size.
          </p>
        </div>
        ...
        {!isMobile && (
          ...
          >
            ...
            <p>
              This card is only visible on tablet and desktop devices.
            </p>
          </div>
        )}
      </div>
