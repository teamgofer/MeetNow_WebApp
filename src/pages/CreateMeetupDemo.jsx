        ...
        <div className="created-meetup-preview">
          ...
          <div className="meetup-card">
            ...
            <p className="meetup-datetime">
              <span className="datetime-label">When:</span>{' '}
              {new Date(createdMeetup.start_time).toLocaleString()}
            </p>
            ...
            <div className="meetup-details">
              ...
              <span className="meetup-participants">
                Max {createdMeetup.max_participants} people
              </span>
            </div>
          </div>
        </div>
