...
const ProximityChatMap = ({
  ...
  useEffect(() => {
    ...
    const detectedHotspots = identifyChatHotspots(
      filteredMessages,
      nearbyUsers,
      options
    );
  ...
  useEffect(() => {
    ...
    if (nearbyUsers && Array.isArray(nearbyUsers)) {
      nearbyUsers.forEach(user => {
        ...
        const privacySettings = user.id === currentUserId
  ...
  }, [mapInstance, nearbyUsers, hotspots, selectedHotspot, userLocation, chatSettings, currentUserId, isUserBlocked, centerOnUser, mapProvider, initialZoom]);
