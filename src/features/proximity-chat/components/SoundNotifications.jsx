...
const SoundNotifications = () => {
  ...
  return (
    <div className="sound-notifications-container" ref={settingsRef}>
      <button className="sound-settings-toggle" {...toggleButtonProps}>
      ...
      {isSettingsOpen && (
        ...
        >
          <h4 id="sound-settings-title" className="settings-header">
            Sound Settings
          </h4>

          <div className="settings-content">
            <div className="sound-toggle-container">
              <label id={soundToggleId} htmlFor="sound-toggle">
                Sound Notifications
              </label>
              <button
                id="sound-toggle"
            ...
            <div className="volume-control-container">
              <label id={volumeSliderId} htmlFor="volume-slider">
                Volume
              </label>
              <input
                id="volume-slider"
      ...
      <div id="sound-status-announcer" className="sr-only" aria-live="polite"></div>
    </div>
  );
};
